...
<html lang="en">
   ...
   <body>
      ...
      <div class="header_section">
         <div class="container">
            <nav class="navbar navbar-dark bg-dark">
               <a class="logo" href="{{ url('public') }}/assets/index.html"><img src="{{ url('public') }}/assets/images/logo.png"></a>
               ...
               <div class="collapse navbar-collapse" id="navbarsExample01">
                  <ul class="navbar-nav mr-auto">
                     <li class="nav-item active">
                        <a class="nav-link" href="{{ url('public') }}/assets/index.html">Home</a>
                     </li>
                     <li class="nav-item">
                        <a class="nav-link" href="{{ url('public') }}/assets/category.html">Kategori</a>
                     </li>
                     <li class="nav-item">
                        <a class="nav-link" href="{{ url('public') }}/assets/produk.html">Produk</a>
                     </li>
                     <li class="nav-item">
                        <a class="nav-link" href="{{ url('public') }}/assets/clients.html">Client</a>
                     </li>
                     <li class="nav-item">
                        <a class="nav-link" href="{{ url('public') }}/assets/contact.html">Contact Us</a>
                     </li>
                  </ul>
               </div>
            </nav>
      ...
      <div class="produk_section layout_padding">
         <div class="container">
            <h1 class="feature_taital">FEATURED PRODUK</h1>
