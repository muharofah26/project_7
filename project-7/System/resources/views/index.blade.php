...
<html lang="en">
   <head>
      ...
      <link rel="stylesheet" href="https://netdna.bootstrapcdn.com/font-awesome/4.0.3/{{url('public/assets')}}/css/font-awesome.css">
      <!-- owl stylesheets --> 
   ...
   <body>
      ...
      <div class="header_section">
            ...
            <nav class="navbar navbar-dark bg-dark">
               ...
               <div class="search_section">
                  <ul>
                     ...
                     <li><a href="#"><img src="{{url('public/assets')}}/images/shopping-bag.png"></a></li>
                     <li><a href="#"><img src="{{url('public/assets')}}/images/search-icon.png"></a></li>
                  </ul>
               </div>
         ...
         <div class="banner_section layout_padding">
            <div id="my_slider" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              <div class="taital_main">
                                 <h4 class="banner_taital"><span class="font_size_90">50%</span> Discount Magic Shop</h4>
                           ...
                           <div class="col-md-6">
                              <div><img src="{{url('public/assets')}}/images/img-1.png" class="image_1"></div>
                           </div>
                        </div>
               ...
               <i class=""><img src="{{url('public/assets')}}/images/left-icon.png"></i>
               </a>
               <a class="carousel-control-next" href="#my_slider" role="button" data-slide="next">
               <i class=""><img src="{{url('public/assets')}}/images/right-icon.png"></i>
               </a>
            </div>
         </div>
         <!--banner section end -->
            ...
            <div class="row">
               <div class="col-lg-4 col-sm-12">
                  <div class="beds_section active">
                     ...
                     <div><img src="{{url('public/assets')}}/images/img-2.png" class="image_2"></div>
               ...
               <div class="col-lg-4 col-sm-12">
                  <div class="beds_section">
                     ...
                     <div><img src="{{url('public/assets')}}/images/img-3.png" class="image_2"></div>
                     <div class="seemore_bt"><a href="#">see More</a></div>
                  </div>
               </div>
               <div class="col-lg-4 col-sm-12">
                  <div class="beds_section">
                     ...
                     <div><img src="{{url('public/assets')}}/images/img-4.png" class="image_2"></div>
                     <div class="seemore_bt"><a href="#">see More</a></div>
                  </div>
               </div>
            </div>
            ...
            <div class="row">
               <div class="col-lg-4 col-sm-12">
                  <div class="beauty_box">
                     ...
                     <div><img src="{{url('public/assets')}}/images/img-5.png" class="image_3"></div>
                     <div class="seemore_bt"><a href="#">see More</a></div>
                  </div>
               </div>
               <div class="col-lg-8 col-sm-12">
                  <div class="beauty_box_1">
                     ...
                     <div><img src="{{url('public/assets')}}/images/img-6.png" class="image_3"></div>
               ...
               <div class="row">
                  <div class="col-sm-5">
                     <div class="feature_box">
                        ...
                        <div><img src="{{url('public/assets')}}/images/img-7.png" class="image_7"></div>
                     </div>
                  ...
                  <div class="col-sm-7">
                     <div class="feature_box_2">
                        <h1 class="readable_text">Readable content of</h1>
                        <div><img src="{{url('public/assets')}}/images/img-8.png" class="image_8"></div>
                        <div class="seemore_bt"><a href="#">see More</a></div>
                     </div>
                  </div>
               </div>
               ...
               <div class="carousel-item active">
                  <div class="container">
                     ...
                     <div class="client_section_2">
                        <div class="image_9"><img src="{{url('public/assets')}}/images/img-9.png"></div>
                        ...
                        <div class="image_9"><img src="{{url('public/assets')}}/images/icon-10.png"></div>
                     </div>
                  </div>
               </div>
               <div class="carousel-item">
               ...
               <div class="col-lg-3 col-sm-6">
                  <div class="information_main">
                     ...
                     <div class="social_icon">
                        <ul>
                           <li><a href="#"><img src="{{url('public/assets')}}/images/fb-icon.png"></a></li>
                           <li><a href="#"><img src="{{url('public/assets')}}/images/twitter-icon.png"></a></li>
                           <li><a href="#"><img src="{{url('public/assets')}}/images/linkedin-icon.png"></a></li>
                           <li><a href="#"><img src="{{url('public/assets')}}/images/instagram-icon.png"></a></li>
                        </ul>
                     </div>
                  </div>
               </div>
      ...
      <script>window.jQuery || document.write('<script src="../../assets/{{url('public/assets')}}/js/vendor/jquery-slim.min.js"><\/script>')</script>
      <script src="../../assets/{{url('public/assets')}}/js/vendor/popper.min.js"></script>
      <script src="../../dist/{{url('public/assets')}}/js/bootstrap.min.js"></script>
   </body>
</html>
