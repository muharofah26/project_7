   ...
   <body>
            ...
            <nav class="navbar navbar-dark bg-dark">
               ...
               <div class="search_section">
                  <ul>
                     ...
                     <li><a href="#"><img src="{{('public/assets')}}/images/shopping-bag.png"></a></li>
                     <li><a href="#"><img src="{{('public/assets')}}/images/search-icon.png"></a></li>
                  </ul>
               </div>
      ...
      <div class="client_section layout_padding">
         <div id="main_slider" class="carousel slide" data-ride="carousel">
               ...
               <div class="carousel-item active">
                  <div class="container">
                     ...
                     <div class="client_section_2">
                        <div class="image_9"><img src="{{('public/assets')}}/images/img-9.png"></div>
                        ...
                        <div class="image_9"><img src="{{('public/assets')}}/images/icon-10.png"></div>
                     </div>
                  </div>
               </div>
            ...
            <i class=""><img src="{{('public/assets')}}/images/left-icon.png"></i>
            </a>
            <a class="carousel-control-next" href="#main_slider" role="button" data-slide="next">
            <i class=""><img src="{{('public/assets')}}/images/right-icon.png"></i>
            </a>
         </div>
      </div>
      <!-- client section end -->
               ...
               <div class="col-lg-3 col-sm-6">
                  <div class="information_main">
                     ...
                     <div class="social_icon">
                        <ul>
                           <li><a href="#"><img src="{{('public/assets')}}/images/fb-icon.png"></a></li>
                           <li><a href="#"><img src="{{('public/assets')}}/images/twitter-icon.png"></a></li>
                           <li><a href="#"><img src="{{('public/assets')}}/images/linkedin-icon.png"></a></li>
                           <li><a href="#"><img src="{{('public/assets')}}/images/instagram-icon.png"></a></li>
                        </ul>
                     </div>
                  </div>
               </div>
