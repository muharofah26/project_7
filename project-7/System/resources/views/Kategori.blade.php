...
<html lang="en">
   ...
   <body>
      ...
      <div class="header_section">
         <div class="container">
            <nav class="navbar navbar-dark bg-dark">
               <a class="logo" href="index.html"><img src="{{ ('public/assets') }}/images/logo.png"></a>
               ...
               <div class="collapse navbar-collapse" id="navbarsExample01">
                  <ul class="navbar-nav mr-auto">
                     ...
                     <li class="nav-item">
                        <a class="nav-link" href="{{ url('public') }}/assets/category.html">Category</a>
                     </li>
                     <li class="nav-item">
                        <a class="nav-link" href="{{ url('public') }}/assets/products.html">Products</a>
                     </li>
                     <li class="nav-item">
      ...
      <!-- javascript --> 
      <script src="{{ url('pulic') }}/assets/js/owl.carousel.js"></script>
